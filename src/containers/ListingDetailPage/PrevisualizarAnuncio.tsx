...
export interface PrevisualizarAnuncioProps {
  className?: string;
}
...
const PrevisualizarAnuncio: FC<PrevisualizarAnuncioProps> = ({
  className = "",
}) => {
    ...
    >
      ...
      <>
        <header className="container 2xl:px-14 rounded-md sm:rounded-xl adpagecontainer">
          <div style={{marginBottom: '44px' , paddingTop: '44px',textAlign:'center'}}>
            {" "}
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">
              O Anúncio encontra-se ainda em aprovação.
              </h2>
          </div>
...
export default PrevisualizarAnuncio;
