...
export interface LocationInputConcelhoProps {
  defaultValue: string;
...
const LocationInputConcelho: FC<LocationInputConcelhoProps> = ({
  defaultValue,
  defaultValueslug,
  autoFocus = false,
  onChange,
  ...
  const renderRecentSearches = () => {
    return (
      <>
        ...
        <div className="mt-2">
          {allconcelhos.map((item: any) => (
            <span
              onClick={() =>
                handleSelectLocation(item?.nome_concelho, item?.slug_concelho)
              }
              key={item?.slug_concelho}
            ...
            >
              ...
              <span className=" block font-medium text-neutral-700 dark:text-neutral-200">
                {capitalizeFirstLetter(item?.nome_concelho)}
              </span>
            </span>
          ))}
        </div>
...
export default LocationInputConcelho;
